...
# 모델 디렉토리 폴더명 패턴: v{NNN}_15m_{start}_{end}
MODEL_VERSIONS = {
    ...
    # BL-1-4: Regime-matched 백테용 (학습 2022-2024 약세+회복 → 백테 2020-2021 강세)
    "v008": "v008_15m_2022-01-01_2024-12-31",
}
...
SPLIT_DEFINITIONS = [
    ...
    # BL-1-4 Regime-matched: 학습 2022-2024 (약세+회복) → 백테 2020-2021 (강세 bull)
    # PPO는 v008 학습 안 함 (사안 W) → single 모드 사용 권장 (full 모드 시 PPO Regime warning)
    ("Regime", "v008", "2020-01-01", "2021-12-31"),
]
