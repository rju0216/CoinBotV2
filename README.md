...
⚠️ live 는 실거래 모드. 시작 전 [INFRA_GUIDE §4 주의점](docs/01_Guide_Docs/INFRA_GUIDE.md) 필독.
...
상세·인프라 구조상 주의점은 [INFRA_GUIDE](docs/01_Guide_Docs/INFRA_GUIDE.md).
...
```
src/
├── core/         # 엔진 공통 (AbstractEngine, types, enums, event_bus)
├── live/         # CoreEngine (paper/live) + trade_sync
...
docs/
├── 00_Work_Reports/        # 작업 보고서
├── 01_Guide_Docs/          # INFRA_GUIDE.md (인프라 구조·신규 전략 추가·주의점)
└── 99_Brainstorming_Docs/  # 모델 설계 브레인스토밍
...
| 문서 | 대상 |
|---|---|
| [INFRA_GUIDE](docs/01_Guide_Docs/INFRA_GUIDE.md) | 아키텍처·모듈 구조·신규 전략 추가법·인프라 구조상 주의점·명령어 |
