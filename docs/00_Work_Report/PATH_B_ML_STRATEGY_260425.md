...
| — | Phase E-2-3: 슬리피지 sensitivity + Calibration | 대기 (E-2-2-FIX 종착 후 재진행) | — | 슬리피지 (I-B010): 분할 1, 4 양 끝점에 5모델 × 4슬리피지 = 40개 백테. Calibration (I-B009): v001만 4개 분류 모델에 Platt+Isotonic 적용 + 백테 8개. **E-2-2-FIX로 정확한 결과 보장 + E-2-2-OPT 단축 효과로 50+개 백테가 ~5h 내 완료 가능**. Step 1 (sensitivity 인프라 코드)은 E-2-2-OPT 커밋에 이미 포함, 백테 자체는 재실행 |
