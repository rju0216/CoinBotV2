...
7. **Lookahead bias 코드 추적** (B-1b 완료 후 추가 — I-B007): 백테 엔진의 generate_signal 호출 시점 + entry_price 결정 시점 정밀 검증. 모든 백테 결과의 신뢰성 기반
