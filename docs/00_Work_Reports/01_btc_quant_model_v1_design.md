...
| I-009 | 매핑 τ 스케일 미스매치: per-state \|μ\|/σ ~0.01-0.1 vs τ=0.5 → 24상태 전부 range, 추세매매 0회 | D4-3 백테 | OPEN | τ 스윕(D4-5, 데이터 분포 기반 0.02~0.11 후보) + `build_regime_artifacts` 에 selection 커버리지(CORE_COMBOS) 미충족 경고 추가 |
